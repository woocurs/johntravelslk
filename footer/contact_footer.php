...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['form_type'])) {
        ...
        if ($form_type === 'contact') {
            ...
            // If no errors, save data and send email
            if (empty($err)) {
    ...
    <div class="footer-section contact-form">
        ...
        <form action="footer.php" method="POST">
            ...
            <div class="recaptcha-container">
                <div class="g-recaptcha" data-sitekey="6Lds54sqAAAAALV-98g_sKaXQQX9llA4o-UbgKV1" data-callback="footrecaptchaCallback"></div>
            </div>
            <button type="submit" disabled id="submit_button">Send Message</button>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    function footrecaptchaCallback(response) {
        if (response) {
