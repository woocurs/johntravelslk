        ...
        <option value="Full Payment"<?php echo (isset($payment) && $payment == 'Full Payment') ? 'selected' : ''; ?>>Full Payment</option>
            ...
            <div class="form-group">
                <label>Reference Number</label>
                  <input type="text" name="reference_number" id="reference_number" value="<?php echo isset($reference_number) ? $reference_number : ''; ?>" placeholder="Referred_by: use(if available) ">
  ...
  <div class="form-group">
    ...
    <img id="photo-preview" src="" alt="Image Preview" style="display: none; max-width:500px;">
            ...
            <div class="form-group">
               ...
               <input type="checkbox" name="terms" id="terms" <?php echo isset($terms) && $terms ? 'checked' : ''; ?> required> I agree to the <a href="terms_and_conditions.php" target="_blank">terms and conditions</a>
            </div>
