    ...
    if (isset($_POST['form_type'])) {
        ...
        if ($form_type === 'booking') {
            ...
            if (empty($mobile) || !preg_match("/^(\+?\d{1,3})?\d{10}$/", $mobile))
                $errors[] = "Mobile number must be valid, with or without a country code.( e.g, 0712345678 or +94712345678).";
            if (!empty($whatsapp) && !preg_match("/^(\+?\d{1,3})?\d{10}$/", $whatsapp))
                $errors[] = "WhatsApp number must be valid, with or without a country code.( e.g, 0712345678 or +94712345678).";
            if (empty($gender))
...
<body>
    ...
    <div class="container">
        <img src="images/Woocurstours logo.png" alt="Johntravels" class="logo">
        ...
        <form action=" " method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" required value="<?php echo isset($name) ? $name : ''; ?>"
                    placeholder="T.John">
            ...
            <div class="form-group">
                ...
                <input type="text" name="address" id="address" required
                    ...
                    placeholder="No.377, Veppankulam,Vavuniya,Srilanka.">

            </div>
            <div class="form-group">
                <label>NIC Number</label>
                <input type="text" name="nic" id="nic" required value="<?php echo isset($nic) ? $nic : ''; ?>"
                    placeholder="199843000123 or 981234567V ">

            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="email" name="email" id="email" value="<?php echo isset($email) ? $email : ''; ?>"
                    placeholder="info.johntravels@gmail.com">

            </div>
            <div class="form-group">
                <label>Mobile Number</label>
                <input type="text" name="mobile" id="mobile" required
                    value="<?php echo isset($mobile) ? $mobile : ''; ?>" placeholder="0712345678 or +94712345678">

            </div>
            <div class="form-group">
                <label>WhatsApp Number</label>
                <input type="text" name="whatsapp" id="whatsapp"
                    value="<?php echo isset($whatsapp) ? $whatsapp : ''; ?>" placeholder="0712345678 or +94712345678">
            ...
            <div class="form-group">
                ...
                <select name="payment" id="payment" required>
                    ...
                    <option value="Advance" <?php echo (isset($payment) && $payment == 'Advance') ? 'selected' : ''; ?>>
                        Advance</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="reference_number" id="reference_number"
                    value="<?php echo isset($reference_number) ? $reference_number : ''; ?>"
                    placeholder="Referred_by: use(if available) ">

            </div>
            <div class="form-group">
                <label>Remark</label>
                <textarea name="remark" id="remark"
                    placeholder="Any Special Needs or Requests (optional)"><?php echo isset($remark) ? $remark : ''; ?></textarea>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="terms" id="terms" <?php echo isset($terms) && $terms ? 'checked' : ''; ?>
                    required> I agree to the <a href="terms_and_conditions.php" target="_blank">terms and conditions</a>
            </div>
