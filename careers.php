                ...
                <div class="vacancy-container col-lg-8">
                    ...
                    <div class="row">
                        <div class="vacancy-content">
                            <h5>Part Time</h5>
                            <h3>Travel Agent</h3>
                            <p>It sounds like you're looking for information related to a travel agent offering local
                                bus services or coordinating bus travel.</p>
                    ...
                    <div class="row">
                        <div class="vacancy-content">
                            ...
                            <p>Ensuring that the tour adheres to the planned schedule and that all stops, attractions,
                                and points of interest are included.</p>
