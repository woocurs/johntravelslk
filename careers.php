                ...
                <div class="section-heading text-center">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <p>Our work philosophy is simple. We want to grow, and we want you to grow. And to make that
                                happen, we encourage you to explore your journey your own way .</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="vacancy-content">
                                <h5>Part Time</h5>
                                <h3>Travel Agent</h3>
                                <p>It sounds like you're looking for information related to a travel agent offering
                                    local bus services or coordinating bus travel.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="vacancy-content">
                                <h5>Part Time</h5>
                                <h3>Tour Guide</h3>
                                <p>Provide a brief description of the bus tour, highlighting the major attractions and
                                    experiences.Offering explanations about landmarks and destinations.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="vacancy-content">
                                ...
                                <p>Ensuring that the tour adheres to the planned schedule and that all stops,
                                    attractions, and points of interest are included.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="vacancy-content">
                                ...
                                <p>Photographer cheering boys capture the moment, boys-smiles are the secret to timeless
                                    shots!</p>
                                <button class="apply-now-btn" data-position="Photo Grapher/Cheer Boys">Apply
                                    Now</button>
                            </div>
                        </div>
                    </div>
