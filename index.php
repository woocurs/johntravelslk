    ...
    <div class="slide active">
        <div class="overlay">
            <div class="left-content">
                ...
                <p>Experience the adventures of Mirabilis: eat, sleep, hike, climb, fly, jump, swim, snorkel, surf, and dive.</p>
                <a href="explore.php" class="button">     Explore More   </a>
            </div>
            <div class="vertical-line"></div>
            <div class="right-content">
                <p>Mirabilis awaits with endless experiences in a land of lush landscapes, stunning beaches, and vibrant culture.</p>
            </div>
        </div>
    </div>
